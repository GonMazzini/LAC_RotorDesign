...
%File names
path1 = 'HAWC_inputs/DTU_10MW_final_flexible_hawc2s';%'HAWC_inputs/DTU_10MW_redesign_flexible_hawc2s'; %Main file 
% path2 = 'HAWC_inputs/DTU_10MW_redesign_rigid_hawc2s'; % rigid to correct deflections 

%Operational file path:
operational_file ='HAWC_inputs/DTU_10MW_final_flexible_hawc2s.opt';% 'HAWC_inputs/DTU_10MW_final_flexible_hawc2s.opt';%'HAWC_inputs/data/operational_finalTSR';%data/operation_mult_WS_final'; % 
...
data_redesign_rig =  readtable(append(path1,'.pwr'),'Filetype', 'text' );
data_redesign_rig = table2array(data_redesign_rig);

data_original_flex =  readtable('original_design/DTU_10MW_flexible_hawc2s.pwr','Filetype', 'text' );
data_original_flex = table2array(data_original_flex);
data_original_rig =  readtable('original_design/DTU_10MW_rigid_hawc2s.pwr','Filetype', 'text' );
data_original_rig = table2array(data_original_rig);

data_prev_flex =  readtable('DTU_10MW_redesign_flexible_hawc2s.pwr','Filetype', 'text' );
data_prev_flex = table2array(data_prev_flex);
...
for i=1:1:3
    ...
    elseif i==2
        ...
        R = 178.3/2;
    elseif i==3
        data_flex = data_prev_flex;
        linestyle = 'r';
        colour = 'red';
        lab = 'DTU 10MW Group Design';
        R = 97.77;
    end
